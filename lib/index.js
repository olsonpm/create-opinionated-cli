...
const createCliMarg = getCliMarg()
  ...
  , {
    createError, getDuplicateArgProps, getDuplicateArgsMatching
    , VIEW_WIDTH, wrapText
  } = common
...
function getMaxLength(argsObj) {
  const commandAliasBarNames = fp.invokeMap('getAliasCommaName', argsObj.commands);
